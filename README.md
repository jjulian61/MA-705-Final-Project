...
The Dashboard allows users to filter properties based on Property Lister and Address
...
Python Programs Used: pandas, selenium, time, re, pickle, html, dash, dcc
...
4. Organized data into Dataframe, then put into Dashboard
...
Dash Template Used:
http://lukecherveny.com/ma705spring22/week10/dash_template_complete.py
